...
$(document).ready(function () {
  ...
  // Prevent text selection only on help content
  $("#helpContent").on("mousedown", function () {
    return false;
  });
  ...
  $(function () {
    $(document).on("click", ".calc_min", function () {
    ...
    $(document).on("click", ".calc_max", function () {
    ...
    $(document).on("click", "#keyPad_Helpback", function () {
      $(this).hide();
      $("#keyPad_Help").show();
      $(".text_container").show();
      $(".left_sec").show();
